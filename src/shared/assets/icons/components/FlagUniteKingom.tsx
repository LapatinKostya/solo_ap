...
const SvgFlagUniteKingom = (
  ...
  >
    <path
      fill='url(#flag-unite-kingom_svg__a)'
      d='M0 0h24v24H0z'
    />
    <defs>
      <pattern
        id='flag-unite-kingom_svg__a'
        width={1}
        height={1}
        patternContentUnits='objectBoundingBox'
      >
        <use
          xlinkHref='#flag-unite-kingom_svg__b'
...
const ForwardRef = forwardRef(SvgFlagUniteKingom)
